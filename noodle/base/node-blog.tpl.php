<?php if ($page == 0): ?>
	...
	<div class="node <?php print $node->type ?> teaser<?php print ($node->sticky) ? " sticky" : ""; ?><?php print ($node->promote) ? " promoted" : ""; ?>">
		...
		<h2><span class="title-alt"><?php print date("Y/m/d", $created) ?> </span> <a href="<?php print $node_url ?>" rel="bookmark" title="Permanent Link to <?php print $title ?>"><?php print $title ?></a></h2>
...
<?php else: ?>
	...
	<?php drupal_set_title($title = "<span class=\"title-alt\">". date("Y/m/d", $created)."</span> ".$title) ?>
